...
int main()
{
	...
	sf::Vector2f spriteSize = sf::Vector2f(AssetManager::GetTexture("small.png").getSize().x, 
		AssetManager::GetTexture("small.png").getSize().y);
	auto& texture = AssetManager::GetTexture("small.png");
